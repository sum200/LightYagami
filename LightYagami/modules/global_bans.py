...
import LightYagami.modules.sql.global_bans_sql as sql
from LightYagami.modules.sql.users_sql import get_user_com_chats
from LightYagami import (DEV_USERS, EVENT_LOGS, OWNER_ID, STRICT_GBAN, DRAGONS,
